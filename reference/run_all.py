...
CHECKS = [
    ...
    ("summerville_tiled", "nonlast_ground", "equal", 0, 0),
    ("summerville_tiled", "delivered_noise", "equal", 4951, 0),
    ("summerville_tiled", "noise_as_ground", "equal", 0, 0),
    ("summerville_tiled", "noise_kept", "equal", 4951, 0),
    ("summerville_tiled", "whole_noise", "equal", 4951, 0),
    ("summerville_tiled", "tiled_noise", "equal", 4951, 0),
    ("summerville_tiled", "tiles", "equal", 12, 0),
    ("summerville_tiled", "seamed", "equal", 12, 0),
    ("summerville_tiled", "halo", "abs", 330.0, 0.1),
    ("summerville_tiled", "largest_box", "abs", 0.5094, 0.001),
    ("summerville_tiled", "area_read", "abs", 3.415, 0.01),
    ("summerville_tiled", "max_tile_points", "equal", 11050836, 0),
    ("summerville_tiled", "whole_ground_fraction", "abs", 0.29556, 0.001),
    ("summerville_tiled", "tiled_ground_fraction", "abs", 0.29556, 0.001),
    ("summerville_tiled", "strip_cells", "equal", 1321500, 0),
    ("summerville_tiled", "strip_default_tiles", "equal", 2, 0),
    ("summerville_tiled", "strip_default_largest_box", "abs", 0.8343, 0.001),
