...
CHECKS = [
    ...
    ("summerville_tiled", "max_tile_points", "equal", 11054341, 0),
    ("summerville_tiled", "whole_ground_fraction", "abs", 0.2957, 0.001),
    ("summerville_tiled", "tiled_ground_fraction", "abs", 0.2957, 0.001),
